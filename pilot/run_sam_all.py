...
OUTPUT_ROOT = Path.home() / "thesis_models/pilot/outputs/sam"
CHECKPOINT = Path.home() / "thesis_models/repos/segment-anything/checkpoints/sam_vit_b_01ec64.pth"
MODEL_TYPE = "vit_b"
...
print(f"Saved SAM masks under: {OUTPUT_ROOT}")
